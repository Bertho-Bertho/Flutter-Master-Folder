...
class _EditProductFormState extends State<EditProductForm> {
            ...
            child: Column(
              ...
              children: [
                ...
                TextFormField(
                  ...
                  style: const TextStyle(color: Colors.white),
                  decoration: _inputStyle('Code SKU', Icons.qr_code_2_rounded),
                  validator: (v) =>
                  ...
                  children: [
                    ...
                    Expanded(
                      child: TextFormField(
                        ...
                        style: const TextStyle(color: Colors.white),
                        keyboardType: TextInputType.number,
                        decoration: _inputStyle('Stock', Icons.numbers_rounded),
                ...
                TextFormField(
                  ...
                  style: const TextStyle(color: Colors.white),
                  maxLines: 3,
                  decoration: _inputStyle('Description', Icons.notes_rounded),
                ),
  ...
  Future<void> _handleUpdate() async {
    if (_formKey.currentState!.validate()) {
      ...
      final error = await context.read<ProductController>().UpdatedProduct(
        updatedProduct,
      );
